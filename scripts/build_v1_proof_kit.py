...
# Requests root: DCS_PROOF_REQUESTS_DIR | NLC_REQUESTS_ROOT | explicit (never hardcoded when proof path differs)
REQUESTS_ROOT="${DCS_PROOF_REQUESTS_DIR:-${NLC_REQUESTS_ROOT:-$KIT_ROOT/state/requests}}"
CLEAN_DIR="$REQUESTS_ROOT"
if [[ ! -d "$NLC_DB" ]]; then
